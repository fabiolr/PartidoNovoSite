<?php include("_head.inc.php") ?>
    ...
    <div class="interna acompanhe">     
        ...
        <?php $eventos = simplexml_load_file("http://novo.org.br/admin_old/gera_xml_evento.php"); ?>

        <section class="sec-a agenda">
            <div class="fix">
                <h1 class="titulo l-40-helvetica-b-cn">Agenda</h1>
                <p>Informamos que os eventos oficiais promovidos pelo NOVO são apenas os listados nesta página. Eventos realizados por apoiadores e colaboradores não têm caráter oficial, podem não apresentar adequadamente as ideias e posicionamentos do NOVO e NÃO estão autorizados a fazer qualquer tipo de cobrança ou receber qualquer tipo de doação no local.<br /><br />

                Todas as doações para o NOVO devem ser realizadas no site do NOVO ou nos eventos OFICIAIS.</p>
                <br><br>
