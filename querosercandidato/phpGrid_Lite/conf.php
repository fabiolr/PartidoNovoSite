...
define('PHPGRID_DB_HOSTNAME', 'novo.cjwhiywpsgop.sa-east-1.rds.amazonaws.com'); // database host name
define('PHPGRID_DB_USERNAME', 'novo_master');     // database user name
define('PHPGRID_DB_PASSWORD', 'ThhHNXBvv66HDi'); // database password
define('PHPGRID_DB_NAME', 'novo'); // database name
