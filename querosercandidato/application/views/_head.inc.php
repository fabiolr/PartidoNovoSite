...
<!--[if gt IE 8]><!-->
<html lang="pt-BR" xmlns="http://www.w3.org/1999/xhtml" xmlns:na="http://schema.org/" xmlns:fb="http://www.facebook.com/2008/fbml" xmlns:og="http://ogp.me/ns#" xmlns:v="http://rdf.data-vocabulary.org/#"> <!--<![endif]-->
<head>
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" href="{base_url}css/webfontkit/stylesheet.css">  
	...
	<script type="text/javascript" src="{base_url}js/validator.min.js"></script>	
