...
/**
 * Classe que inicia o login ao ADM
 * 
 * @author hermes *
 *        
 */
class Adm extends CI_Controller {
	...
	/**
	 * configura a pagina css , js
	 */
	function pag_conf() {
		$this->data ['title'] = 'Login Administrativo';
		$this->data ['js'] = array (
				array (
						'js_url' => 'http://code.jquery.com/jquery-latest.min.js' 
				),
				array (
						'js_url' => 'http://ajax.googleapis.com/ajax/libs/jqueryui/1.10.3/jquery-ui.min.js' 
				),
				array (
						'js_url' => base_url () . 'js/bootstrap.js' 
				) 
		)
		;
		$this->data ['css'] = array (
				...
				array (
						'css_url' => base_url () . 'bootstrap-responsive.min.css' 
				),
				array (
						'css_url' => base_url () . 'css2/style.css' 
				) 
		)
		;
	}
	 ...
	 */
	function start($msg = '') {
		$this->data ['str_login_msg'] = $msg; // msg de erro iniciailmente em branco
	...
	/**
	 * Cria a sessao do login
	 * 
	 * @param  $logon  registro do usuario logado      	
	 */
