        ...
        <section class="sec-a midias-sociais">
            <div class="fix">
                ...
                <div class="lista p-15">
                    ...
                    <a href="https://twitter.com/partidonovo30" class="cada twitter">
                    ...
                    <a href="https://www.youtube.com/partidonovo30" class="cada youtube">
        ...
        <section class="menu-int">
            <div class="fix">
                ...
                <nav class="lista">
	                ...
	                <a href="prestacao-de-contas.php" class="cada azul last">
                        <span class="tit b-18"> Prestação <br>de Contas</span>
