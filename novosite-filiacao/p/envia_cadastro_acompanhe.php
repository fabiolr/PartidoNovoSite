...
$result = mysql_query("SELECT id FROM contacts WHERE email = '{$email}';");

if(mysql_num_rows($result) > 0) {

	echo '<script>alert("Este e-mail já está cadastrado. Se você quiser alterar o e-mail ou editar o seu cadastro envie uma mensagem através da página \"Fale com a gente\"."); location.href = "../cadastro.php";</script>';
	exit;
