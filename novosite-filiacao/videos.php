<?php include("_head.inc.php") ?>
    ...
    <div class="interna divulgue">
        
       <?php include("_header.inc.php") ?>        

            <div class="txt-header">
                <h1 class="tit-header">Divulgue</h1>
                <p>O NOVO quer reunir pessoas <br>em torno de ideias simples</p>
            </div>
        ...
        <section class="sec-a divulgue videos">
            <div class="fix">
                <h1 class="titulo l-40-helvetica-b-cn">Vídeos</h1>
                <div class="lista p-15">
                    
                    <div class="container-video">
                        <img src="images/videos/1.jpg" alt="" class="video-thumb" />
                        <img src="images/seta-video.png" alt="" class="video-seta" />
                        <div class="video-info">
                            <p>Apresent. Rio de Janeiro - 30 de Outubro - 1a Parte</p>
                            <p><a href="https://www.youtube.com/watch?v=fB8NUjIj7FU" target="_blank">&rtrif; Assistir</a></p>
                        </div>
                    </div>

                    <div class="container-video">
                        <img src="images/videos/2.jpg" alt="" class="video-thumb" />
                        <img src="images/seta-video.png" alt="" class="video-seta" />
                        <div class="video-info">
                            <p>Apresent. Rio de Janeiro - 30 de Outubro - 2a Parte</p>
                            <p><a href="https://www.youtube.com/watch?v=0I-lGAA6jE8" target="_blank">&rtrif; Assistir</a></p>
                        </div>
                    </div>

                    <div class="container-video">
                        <img src="images/videos/4.jpg" alt="" class="video-thumb" />
                        <img src="images/seta-video.png" alt="" class="video-seta" />
                        <div class="video-info">
                            <p>Encontro Nacional do NOVO | Manhã</p>
                            <p><a href="https://www.youtube.com/watch?v=RsoL7dfcjv8" target="_blank">&rtrif; Assistir</a></p>
                        </div>
                    </div>

                    <div class="container-video">
                        <img src="images/videos/5.jpg" alt="" class="video-thumb" />
                        <img src="images/seta-video.png" alt="" class="video-seta" />
                        <div class="video-info">
                            <p>Encontro Nacional do NOVO | Tarde</p>
                            <p><a href="https://www.youtube.com/watch?v=yhADIB3FHAU" target="_blank">&rtrif; Assistir</a></p>
                        </div>
                    </div>

                    <div class="container-video">
                        <img src="images/videos/6.jpg" alt="" class="video-thumb" />
                        <img src="images/seta-video.png" alt="" class="video-seta" />
                        <div class="video-info">
                            <p>Depoimentos de apoiadores do NOVO</p>
                            <p><a href="https://www.youtube.com/watch?v=SQ4KUZG1ZjM" target="_blank">&rtrif; Assistir</a></p>
                        </div>
                    </div>
                ...
                <div class="icones">
                    <a href="http://bit.ly/1l1xED3" class="cada">
                        <span class="img"><img src="images/filiese-manual.png" alt="Manual do Novo"></span>
                        <h2>Manual <br>do Novo</h2>
                    </a>
                    <a href="http://novo.org.br/downloads/apresentacaonovo.zip" class="cada">
        ...
        <section class="sec-a ferramentas">
            <div class="fix">
                <h1 class="titulo l-40-helvetica-b-cn">Ferramentas</h1>
                <div class="lista">
                    <div class="cada simbolo">
                        <h2>USE O SÍMBOLO DO<br>NOVO NO SEU PERFIL</h2>
                        <a href="http://twibbon.com/Support/novo30" class="img" target="_blank"><img src="images/divulgue-simbolo.png" alt="Símbolo do NOVO"></a>
                        <a href="http://twibbon.com/Support/novo30" class="bt-preto" target="_blank">Criar avatar</a>
                    </div>
                    <div class="cada simbolo">
